...
async function cloneVideoElement(video, options) {
  if (video.currentSrc) {
    ...
    ctx2 === null || ctx2 === void 0 ? void 0 : ctx2.drawImage(video, 0, 0, canvas2.width, canvas2.height);
...
// public/20260519162622_da31ca75-fa53-416c-a707-1636177e7f2b/appHelper.ts
var AppHelper;
...
var init_confetti_module = __esm({
  "node_modules/canvas-confetti/dist/confetti.module.mjs"() {
    ...
    (function main(global2, module2, isWorker, workerSize) {
      ...
      function animate(canvas2, fettis, resizer, size, done) {
        ...
        var prom = promise(function(resolve) {
          ...
          function update2() {
            if (isWorker && !(size.width === workerSize.width && size.height === workerSize.height)) {
              size.width = canvas2.width = workerSize.width;
              size.height = canvas2.height = workerSize.height;
            }
            if (!size.width && !size.height) {
              resizer(canvas2);
              size.width = canvas2.width;
              size.height = canvas2.height;
            }
            context.clearRect(0, 0, size.width, size.height);
      ...
      function confettiCannon(canvas2, globalOpts) {
        ...
        function fireLocal(options, size, done) {
          ...
          animationObj = animate(canvas2, fettis, resizer, size, done);
        ...
        function fire(options) {
          ...
          function done() {
            ...
            if (isLibCanvas && canvas2) {
              if (document.body.contains(canvas2)) {
...
// public/20260519162622_da31ca75-fa53-416c-a707-1636177e7f2b/app.ts
...
function initSounds() {
  if (bgm) return;
  bgm = new import_howler.Howl({ src: [getAssetPath("bgm")], loop: true, volume: 0.5 });
  sndPlace = new import_howler.Howl({ src: [getAssetPath("place")], volume: 0.8 });
  sndRotate = new import_howler.Howl({ src: [getAssetPath("rotate")], volume: 0.8 });
  sndHit = new import_howler.Howl({ src: [getAssetPath("hit")], volume: 0.8 });
  sndClear = new import_howler.Howl({ src: [getAssetPath("clear")], volume: 1 });
  bgm.play();
}
...
function onPointerUp(e) {
  ...
  if (isClick && draggingMirror.c !== -1) {
    ...
    const inGrid = pos.x > gridOffsetX && pos.x < gridOffsetX + gridCols * gridCellSize && pos.y > gridOffsetY && pos.y < gridOffsetY + gridRows * gridCellSize;
...
function drawMirror(x, y, type, isIcon) {
...
function draw() {
  if (gameState === 0 /* TITLE */ || gameState === 1 /* INSTRUCTIONS */) {
    drawTitleBg();
    return;
  }
  if (gameState === 4 /* ALL_CLEAR */) {
    ctx.fillStyle = "#000";
    ctx.fillRect(0, 0, LOGICAL_WIDTH, LOGICAL_HEIGHT);
    return;
  }
...
var import_howler, Mirror, LOGICAL_WIDTH, LOGICAL_HEIGHT, gameState, currentStageIndex, appData, textData, assetList, ctx, canvas, uiLayer, bgm, sndPlace, sndRotate, sndHit, sndClear, gridCols, gridRows, gridCellSize, gridOffsetX, gridOffsetY, mapGrid, inventoryCount, mirrors, draggingMirror, isDragging, pointerDownX, pointerDownY, pointerDownTime, emitterC, emitterR, emitterDx, emitterDy, laserPath, isTargetHit, stageClearDelay, titleTime;
var init_app = __esm({
  "public/20260519162622_da31ca75-fa53-416c-a707-1636177e7f2b/app.ts"() {
    init_appHelper();
...
// public/20260519162622_da31ca75-fa53-416c-a707-1636177e7f2b/main.ts
